...
#pragma warning disable 649
    ...
    /// (see: https://msdn.microsoft.com/en-us/library/ms646271.aspx)
    ...
    struct KEYBDINPUT
    {
        ...
        /// The code must be a value in the range 1 to 254. The Winuser.h header file provides macro definitions (VK_*) for each value. If the dwFlags member specifies KEYEVENTF_UNICODE, wVk must be 0. 
        /// </summary>
        public UInt16 Vk;
